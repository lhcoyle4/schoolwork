...
Brief Description:
  Given an array of characters, determine if it's a palindrome using either 
  array subscripting(palindrome1.c) or pointers(palindrome2.c). Returns 1 (true)
  if the phrase is a palindrome and 0 if not.
