...
#include "histogram.h" /* lab functions */

const char s0[] = "Real simple.";

const char s1[] = "This is simple - a sentence with spaces - and other punctuations.";
...
void DoTest(const char array[], int size)
{
  ...
  count = GetCounts(array, size, letters, &spaces, &other);
...
int main(int argc, char *argv[])
{
  ...
  {
    case 0:
      DoTest(s0, sizeof(s0) - 1);
      break;
    case 1:
      DoTest(s1, sizeof(s1) - 1);
      break;
    case 2:
      DoTest(s2, sizeof(s2) - 1);
      break;
    case 3:
      DoTest(s3, sizeof(s3) - 1);
      break;
    case 4:
      DoTest(s4, sizeof(s4) - 1);
      break;
  }
