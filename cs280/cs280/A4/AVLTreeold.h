...
class AVLTree : public BSTree<T>
{
  ...
  private:
    ...
    void insert_node_avl_helper(typename BSTree<T>::BinTree &tree, const T& value, std::stack<typename BSTree<T>::BinTree*> &nodes);
    void remove_node_avl(typename BSTree<T>::BinTree &tree, const T& value);
    void remove_node_avl_helper(typename BSTree<T>::BinTree &tree, const T& value, std::stack<typename BSTree<T>::BinTree*> &nodes);
